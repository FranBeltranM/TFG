...
export default class Registro {
  constructor(data) {
    ...
    this.fec_tramitacion =
      data.slice(9, 17).trim() === ''
        ? null
        : moment(data.slice(9, 17), 'DDMMYYYY').format('YYYYMMDD')
    ...
    this.cod_propulsion_itv =
      data.slice(93, 94).trim() === '' ? null : data.slice(93, 94).trim()
    ...
    this.ind_precinto =
      data.slice(120, 122).trim() === '' ? null : data.slice(120, 122).trim()
    this.ind_embargo =
      data.slice(122, 124).trim() === '' ? null : data.slice(122, 124).trim()
    this.num_transmisiones = Number(data.slice(124, 126))
    this.num_titulares = Number(data.slice(126, 128))
    this.localidad_vehiculo =
      data.slice(128, 152).trim() === '' ? null : data.slice(128, 152).trim()
    ...
    this.fec_tramite = moment(data.slice(157, 165), 'DDMMYYYY').format(
      'YYYYMMDD'
    )
    this.codigo_postal = Number(data.slice(165, 170))
    this.fec_prim_matriculacion =
      data.slice(170, 178).trim() === ''
        ? null
        : moment(data.slice(170, 178), 'DDMMYYYY').format('YYYYMMDD')
    this.ind_nuevo_usado = data.slice(178, 179)
    this.persona_fisica_juridica = data.slice(179, 180)
    this.codigo_itv =
      data.slice(180, 189).trim() === '' ? null : data.slice(180, 189).trim()
    ...
    this.kw_itv =
      data.slice(227, 234) !== '*******' ? Number(data.slice(227, 234)) : null
    ...
    this.cod_posesion =
      data.slice(244, 245) === ' ' ? null : data.slice(244, 245)
    this.ind_baja_def =
      data.slice(245, 246) === ' ' ? null : data.slice(245, 246)
    this.ind_baja_temp =
      data.slice(246, 247) === ' ' ? null : data.slice(246, 247)
    this.ind_sustraccion =
      data.slice(247, 248) === ' ' ? null : data.slice(247, 248)
    this.baja_telematica =
      data.slice(248, 259).trim() === '' ? null : data.slice(248, 259).trim()
    this.tipo_itv =
      data.slice(259, 284).trim() === '' ? null : data.slice(259, 284).trim()
    this.variante_itv =
      data.slice(284, 309).trim() === '' ? null : data.slice(284, 309).trim()
    this.version_itv =
      data.slice(309, 344).trim() === '' ? null : data.slice(309, 344).trim()
    this.fabricante_itv =
      data.slice(344, 414).trim() === '' ? null : data.slice(344, 414).trim()
    ...
    this.categoria_homologacion_europea_itv =
      data.slice(426, 430).trim() === '' ? null : data.slice(426, 430).trim()
    this.carroceria =
      data.slice(430, 434).trim() === '' ? null : data.slice(430, 434).trim()
    this.plazas_pie = data.slice(434, 437).trim()
    this.nivel_emisiones_euro_itv =
      data.slice(437, 445).trim() === '' ? null : data.slice(437, 445).trim()
    this.consumo_wh_km_itv = data.slice(445, 449).trim()
    this.clasificacion_reglamento_vehiculos_itv = data.slice(449, 453).trim()
    this.categoria_vehiculo_electrico =
      data.slice(453, 457).trim() === '' ? null : data.slice(453, 457).trim()
    this.autonomia_vehiculo_electrico =
      data.slice(457, 463).trim() === '' ? null : data.slice(457, 463).trim()
    this.marca_vehiculo_base =
      data.slice(463, 493).trim() === '' ? null : data.slice(463, 493).trim()
    this.fabricante_vehiculo_base =
      data.slice(493, 543).trim() === '' ? null : data.slice(493, 543).trim()
    this.tipo_vehiculo_base =
      data.slice(543, 578).trim() === '' ? null : data.slice(543, 578).trim()
    this.variante_vehiculo_base =
      data.slice(578, 603).trim() === '' ? null : data.slice(578, 603).trim()
    this.version_vehiculo_base =
      data.slice(603, 638).trim() === '' ? null : data.slice(603, 638).trim()
    ...
    this.tipo_alimentacion_itv =
      data.slice(650, 651).trim() === '' ? null : data.slice(650, 651).trim()
    this.contrasena_homologacion_itv =
      data.slice(651, 676).trim() === '' ? null : data.slice(651, 676).trim()
    this.eco_innovacion_itv =
      data.slice(676, 677).trim() === '' ? null : data.slice(676, 677).trim()
    this.reduccion_eco_itv =
      data.slice(677, 681).trim() === '' ? null : data.slice(677, 681).trim()
    this.codigo_eco_itv =
      data.slice(681, 706).trim() === '' ? null : data.slice(681, 706).trim()
    this.fec_proceso = moment(data.slice(706, 714), 'DDMMYYYY').format(
      'YYYYMMDD'
    )
  }
  ...
  get getMarcaModelo() {
    return [this.marca_itv, this.modelo_itv]
  }
  ...
  get getDatosTransferencia() {
    return [this.fec_tramite, this.fec_tramitacion, this.fec_proceso]
  }
